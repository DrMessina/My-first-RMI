...
public class Chat_GUI implements GUIInterface, ActionListener, ComponentListener, ListSelectionListener {
	...
	/**
	 * cr�e l'interfac de chat client.
	 * @param nickname
	 * 		pseudo utilisateur.
	 */
	...
	/**
	 * affiche toute les rooms qui on �t� cr�e sur le client.
	 * 
	 */
	...
	/**
	 * Erreur si le serveur n'est pas allum�e.
	 */
